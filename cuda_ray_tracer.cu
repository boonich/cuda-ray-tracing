...
*
*  This version is ported (with minor modifications) to Linux. It has
*  been compiled successfully with gcc on many versions of Linux
   (CentOS 7, Alma Linux 8, Rocky Linux 8 and Ubuntu 18.04).
...
#include "/usr/local/cuda-10.1/samples/common/inc/GL/glew.h"
#include "/usr/local/cuda-10.1/samples/common/inc/GL/glut.h"
...
struct Box {
	...
	__device__ float3 normalAt(float3 &point) {
